...
lin <- lm(mpg ~ vehicle_length + vehicle_weight + spoiler_angle + ground_clearance + AWD, data=MechaCar_mpg)
...
#create a lot_summary dataframe using the group_by() and the summarize() functionsn to group each manufacturing lot by the mean, median, variance, and standard deviation of the suspension coil's PSI column
